...
check-btn = 👀 View
customzn-btn = Customisation
language-btn = Language
anncmt-btn = Notification
...
# --- Messages --- #
start-msg =
    ✦ <b>Sumplete —</b> puzzle game invented by <b>AI</b>
    This game combines 3 popular puzzles: <b>Sudoku</b>, <b>Kakuro</b> and <b>Hitori</b>

    ❔ <b><u>What bot offer</u></b>
        • Convenient complexity selection
        • Various styles of numbers
        • Daily Puzzles
        • And so much more

    🌟 <b>Press /play</b> to start
...
solve-msg = You are solved this puzzle
            Do you solve again without points?
...
choose-msg = Select the <b>size</b> and <b>complexity</b>:
...
mode-msg =
    Press <b>Unfold</b> to get the entire list